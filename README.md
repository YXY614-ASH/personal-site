...
V0.2 个人资料完善版本。吴佳诣，本科学历，电气工程及其自动化专业。围绕个人介绍、项目实践、技术笔记与履历建立持续迭代的技术空间。
...
| 网站项目 | `/projects/personal-site/` | 当前项目说明与 V0.1 / V0.2 版本记录 |
...
学历与专业已根据用户提供的信息录入。院校、就读时间、正式 PDF 简历和 AI 项目运行资料尚未提供。简历下载按钮保持禁用，后续接入真实文件时需同时修改简历模板与测试。
...
- [V0.2 版本文档](docs/versions/V0.2.md)
- [V0.2 测试报告](docs/versions/V0.2-test-report.md)
- [V0.1 历史版本文档](docs/versions/V0.1.md)
- [更新日志](CHANGELOG.md)
- [素材来源](docs/ASSETS.md)

仓库：`git@github.com:YXY614-ASH/personal-site.git`。当前正式归档标签为 `V0.2`，保留 `V0.1` 标签及远端原始历史。按用户选择仅在本地验收，不进行公网发布。
